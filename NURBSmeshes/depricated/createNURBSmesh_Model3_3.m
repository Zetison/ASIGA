...
if true
    chimin = 24.4;
    chimax = 25.7;
    fluid_o = getModel3Data(R_o1+t/10, R_o2+t/10, R_o1, R_o2, L, alignWithAxis, eta1, eta2, x_0);
    noNewZetaKnots = 0;
else
    chimin = 24.4;
    chimax = 27.7;
    fluid_o = getModel3Data(R_o1+50*t, R_o2+50*t, R_o1, R_o2, L, alignWithAxis, eta1, eta2, x_0);
...
fluid_o = insertKnotsInNURBS(fluid_o,{insertUniform2(fluid_o.knots{1}, noNewXiKnots) ...
                                  [insertUniform2([0 eta1], noNewEtaKnotsEnds); ...
                                   insertUniform2([eta1 eta2], noNewEtaKnotsMiddle); ...
                                   insertUniform2([eta2 1], noNewEtaKnotsEnds)] ...
                                  insertUniform2(fluid_o.knots{3}, noNewZetaKnots)});
