function hermite_rule2( n, a, b, scale, filename )
%% This function is a modification of the program found at
...
%
%      C * integral ( 0 < x < +oo ) f(x) rho(x) dx
%
...
%    John Burkardt
% for n = 1:64
%     filename = ['integration/hermiteData/n_' num2str(n) '_r_' num2str(1)];
%     hermite_rule(n, 0, 1, 0, filename);
% end
% 
% for n = 1:64
%     filename = ['integration/hermiteData/n_' num2str(n) '_r_' num2str(0)];
%     laguerre_rule(n, 0, 1, filename);
% end
