...
%                                 warning('Knots inserted for compatability. Note that this routine should be optimized by simply updating geometry for each newly added patch')
    ...
    function S2Vobj = computeCornerData(S2Vobj,indices)
        ...
        if isempty(S2Vobj.cornerData)
            ...
            if noNewFields == 0 % Recompute existing data
                noFields = numel(indices);
                S2Vobj.cornerData(indices) = struct('X', cell(1, noFields), ...
                                                 'v_t1', cell(1, noFields), ...
                                                 'v_t2', cell(1, noFields), ...
                                                 'v_xi', cell(1, noFields), ...
                                                 'v_eta', cell(1, noFields), ...
                                                 'cornerAngle', cell(1, noFields), ...
                                                 'v_n', cell(1, noFields), ...
                                                 'avg_v_n', cell(1, noFields));
                S2Vobj.edgeData(indices) = struct('X', cell(1, noFields), ...
                                                 'v_xi', cell(1, noFields), ...
                                                 'v_eta', cell(1, noFields), ...
                                                 'v_n', cell(1, noFields), ...
                                                 'avg_v_n', cell(1, noFields), ...
