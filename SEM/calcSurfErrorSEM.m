function surfaceError = calcSurfErrorSEM(varCol, UU, task.LpOrder)
...
[Wzeta,Qzeta] = gaussianQuadNURBS(neta); 
nzeta = 1;
...
% for patch = 1:noPatches
    ...
    WW = copyVector2(Wxi.',neta,nzeta,1).*copyVector2(Weta.',nxi,nzeta,2);
