function [A_inf, newDofsToRemove] = addInfElements(varCol, k, f, r_a)
...
parfor e = 1:noElemsXiEta
    ...
    for gp = 1:size(W2D,1)
        ...
        [radius, theta, ~, T] = evaluateProlateCoords(x,y,z,f);
        
        DPDX = dPdX(x,y,z,f,radius,theta,T);
            ...
            for im = 1:N
                for jm = 1:N
                    ...
                    switch infiniteElementFormulation
                        ...
                        case {'PGC', 'BGC'}
                            if mm == 1 && nm == 1
                                slf  = J1_AB*((1-f^2*k^2)*I1(2) - f^2*I1(4) - 1i*k) ...
                                       + J2_AB*I1(2) + J3_AB*I2(1) - J4_AB*f^2*I2(3) + J5_AB*k^2*f^2*I1(2);
                            else
