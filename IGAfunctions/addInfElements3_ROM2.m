function [A, A2, A3, newDofsToRemove] = addInfElements3_ROM2(varCol)
            ...
            for nt = 1:N
                for mt = 1:N
                    switch formulation
                        ...
                        case 'BGC'
                            if mt+nt == 2
%                                 temp  = A1_IJ*((1 - varrho3^2)*B1(2) ...
%                                               - varrho1^2*B1(4) - 1i*varrho2) ...
%                                        + A2_IJ*B1(2) + varrho3^2*A3_IJ*B1(2) ...
%                                        + A4_IJ*B2(1) - varrho1^2*A5_IJ*B2(3);
                                tempI  = A1_IJ*(-varrho3^2*B1(2)) ...
                                       + varrho3^2*A3_IJ*B1(2);
                                tempI2  = A1_IJ*(-1i*varrho2);
                                tempI3  = A1_IJ*(B1(2) - varrho1^2*B1(4)) ...
                                       + A2_IJ*B1(2) + A4_IJ*B2(1) - varrho1^2*A5_IJ*B2(3);
                            else
%                                 temp  = A1_IJ*(-1i*varrho2*(nt-mt)*B1(nt+mt-1) + (nt*mt - varrho3^2)*B1(nt+mt) ...
...
%                                        + A4_IJ*B2(nt+mt-1) - varrho1^2*A5_IJ*B2(nt+mt+1);
                                tempI  = A1_IJ*((-varrho3^2)*B1(nt+mt)) + varrho3^2*A3_IJ*B1(nt+mt);
                                tempI2  = A1_IJ*(-1i*varrho2*(nt-mt)*B1(nt+mt-1) + 1i*varrho1*varrho3*(nt-mt)*B1(nt+mt+1));
                                tempI3  = A1_IJ*(nt*mt*B1(nt+mt) - varrho1^2*nt*mt*B1(nt+mt+2)) ...
                                       + A2_IJ*B1(nt+mt) + A4_IJ*B2(nt+mt-1) - varrho1^2*A5_IJ*B2(nt+mt+1);
                            end
                    end
                    
                    switch formulation
                        case {'PGC', 'BGC'}
                            temp = temp + Dt(n,nt)*D(m,mt)*r_a*tempI/k^2;
                            temp2 = temp2 + Dt(n,nt)*D(m,mt)*r_a*tempI2/k;
