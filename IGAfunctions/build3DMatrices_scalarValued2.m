function A = build3DMatrices_scalarValued2(p, q, r, Xi, Eta, Zeta, noDofs, element, noElems, index, elRangeXi, elRangeEta,elRangeZeta, controlPts, weights, k_wn, memoryCheap)
% initialization
