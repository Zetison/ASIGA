...
extraXiPts = noAnalysisArr(degreeElev+1) - M; % .. per element
extraEtaPts = noAnalysisArr(degreeElev+1) - M; % .. per element
extraZetaPts = noAnalysisArr(degreeElev+1) - M; % .. per element
