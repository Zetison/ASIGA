...
extraGPBEM = 40; % extra quadrature points around singularities for BEM formulations
agpBEM = 1; % parameter for adaptiv Gauss point integration around singularities for BEM formulations
useROM = false;
